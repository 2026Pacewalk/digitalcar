    ...
    <ModuleShell title="Payments" subtitle="Let customers pay you directly from your card" icon={Wallet}
      ...
      <Panel title="Wallets & Payment Links" subtitle="One-tap options and international links">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Field label="Paytm Number"><div className="relative"><Smartphone size={15} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#94A3B8]" /><input value={val("paytm_number")} onChange={(e) => set("paytm_number", e.target.value)} className={`${fieldCls} pl-9`} placeholder="98765 43210" /></div></Field>
          <Field label="PhonePe Number"><div className="relative"><Smartphone size={15} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#94A3B8]" /><input value={val("phone_pe")} onChange={(e) => set("phone_pe", e.target.value)} className={`${fieldCls} pl-9`} placeholder="98765 43210" /></div></Field>
          <Field label="Google Pay Number"><div className="relative"><Smartphone size={15} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#94A3B8]" /><input value={val("google_pay")} onChange={(e) => set("google_pay", e.target.value)} className={`${fieldCls} pl-9`} placeholder="98765 43210" /></div></Field>
