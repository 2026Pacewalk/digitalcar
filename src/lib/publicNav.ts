...
export const HEADER_MENUS: HeaderMenu[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Reseller program", href: "/resellers", desc: "Earn 20% on every plan your customers buy" },
      { label: "Refer & earn", href: "/refer-earn", desc: "Friends get 15% off, you earn 15% cash" },
    ],
    feature: {
      eyebrow: "Partners",
      title: "Grow with DigitalCarda",
      text: "Resell digital cards to your clients and earn 20% on every plan, with payouts whenever you ask.",
      href: "/resellers",
