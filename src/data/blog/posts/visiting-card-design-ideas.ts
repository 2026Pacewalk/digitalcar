...
export const visitingCardDesignIdeas: BlogPost = {
  ...
  seoTitle: "Visiting Card Design Ideas That Actually Get You Calls",
  description: "Practical visiting card design ideas: layout, fonts, colours, what to leave off, and how to design a digital visiting card that looks great on a phone.",
  ...
  intro: [
    "Search \"visiting card design\" and you'll find thousands of templates — gold foil, gradients, geometric patterns. They look great as thumbnails. Then you hold one in your hand, or open it on a phone, and you can't find the phone number.",
    "A visiting card has one job: make a stranger remember you and know how to reach you. Every design choice should serve that. Here are the ideas that do, whether your card is printed, digital, or both.",
  ],
  sections: [
    {
      id: "hierarchy",
      heading: "Start with hierarchy, not decoration",
      blocks: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "ul", items: [
          ...
          "**7. Check contrast.** Light grey text on white, or gold on yellow, looks elegant on screen and disappears in print.",
        ] },
        ...
        { type: "ul", items: [
          ...
          "**9. Add one line of proof.** \"15 years in residential interiors\" or \"Registered with the Bar Council\" builds trust quickly.",
    ...
    {
      id: "digital",
      heading: "Designing a digital visiting card is different",
      blocks: [
        { type: "p", text: "A digital card is seen on a phone, often while someone is walking, waiting or half-listening. That changes the rules a little." },
        { type: "table", head: ["Printed card", "Digital card"], rows: [
          ...
          ["The number must be readable", "The Call and WhatsApp buttons must be easy to tap with a thumb"],
        ...
        { type: "p", text: "The easiest way to get this right is to start from a template built for phones. You can open every one of our [50+ digital card templates](/digital-business-cards-templates) as a live demo and see it on your own phone before choosing." },
    ...
    },
    {
      ...
      blocks: [
        { type: "checklist", items: [
          ...
          "Different details on your card, website and Google profile",
        ] },
        { type: "cta", title: "Skip the designer, keep the design", text: "Pick a professionally designed digital card, add your details and share it today. Free for 30 days.", href: "/signup?promo=FREE30D", label: "Browse designs free" },
      ],
    },
  ],
  faqs: [
    { q: "What should be on a visiting card design?", a: "Your name or business name, what you do in plain words, a phone number, and ideally a QR code that opens your full digital card. Add an email and address only if customers use them." },
    { q: "How many fonts and colours should a visiting card use?", a: "One or two fonts and two or three colours. Fewer choices look more confident and are easier to read." },
    ...
    { q: "Should I put a QR code on my visiting card?", a: "Yes. A QR code links your printed card to your digital card, where people can save your contact, message you and see your work." },
  ],
