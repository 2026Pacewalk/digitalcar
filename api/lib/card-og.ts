...
export interface CardMeta {
  ...
  robots?: string;
  /** Open Graph article tags, for blog articles (ogType "article"). */
...
export function injectCardMeta(html: string, meta: CardMeta): string {
  ...
  const tags = [
    ...
    ...(meta.article ? [
      `<meta property="article:published_time" content="${esc(meta.article.publishedTime)}">`,
      `<meta property="article:modified_time" content="${esc(meta.article.modifiedTime)}">`,
      ...(meta.article.section ? [`<meta property="article:section" content="${esc(meta.article.section)}">`] : []),
      ...(meta.article.tags ?? []).map((t) => `<meta property="article:tag" content="${esc(t)}">`),
    ] : []),
