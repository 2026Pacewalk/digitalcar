    ...
    <div className="space-y-5">
      ...
      <div className="rounded-2xl border border-[#EEF2F7] bg-[#F8FAFC] p-4 flex flex-col sm:flex-row gap-4 sm:items-center">
        <div className="flex flex-col items-center gap-2 shrink-0 mx-auto sm:mx-0">
          <ImagePick value={val("logo")} onChange={(u) => { set("logo", u); if (!u) set("brand_colors", ""); }} className="w-24 h-24 rounded-2xl ring-4 ring-white shadow-sm" label="Add logo" fit="contain" removable what="logo"
      ...
      <div className="pt-4 border-t border-[#F1F5F9]">
        ...
        <div className="flex items-start gap-4">
          <ImagePick value={val("photo")} onChange={(u) => set("photo", u)} className="w-20 h-20 rounded-xl" label="Photo" fit="cover" removable what="photo"
